...
├── src/
│   ├── attacks.py     # Attack vector implementations
│   ├── modern_cli.py  # Rich UI and CLI logic
│   ├── classes.py     # Dispatchers and Monitor classes
│   ├── security.py    # Resource checks and validation
│   ├── utils.py       # Headers and file utilities
│   └── config.py      # Banners and constants
